...
func (r *Redis) HashSet(key string, values ...interface{}) error {
	return r.client.HSet(context.TODO(), key, values...).Err()
}

func (r *Redis) HashMSet(key string, values ...interface{}) error {
	return r.client.HMSet(context.TODO(), key, values...).Err()
}
