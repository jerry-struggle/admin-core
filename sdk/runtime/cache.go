...
func (e Cache) HashSet(key string, values ...interface{}) error {
	return e.store.HashSet(e.prefix+intervalTenant+key, values)
}

func (e Cache) HashMSet(key string, values ...interface{}) error {
	return e.store.HashMSet(e.prefix+intervalTenant+key, values)
}

func (e Cache) Exists(key string) (int64, error) {
